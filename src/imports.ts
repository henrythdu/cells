...
interface ImportContext {
   ...
   *  importers that cruise the FS remap their output paths to repo-relative. */
  baseDir?: string;
 ...
 * a file uses ownership-derived module maps + on-disk probes (each language's
 * importer spec in src/languages/ decides its own resolution).
 *
